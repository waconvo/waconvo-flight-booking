 ...
 * @property {string} clientVersion the version of the WAConvo library
...
class Request {
   ...
   */
  userAgent() {
    let userAgent = `waconvo-flight-booking/${this.clientVersion} node/${this.languageVersion}`;
  ...
  addContentTypeHeader() {
    if (this.verb === 'POST' && !this.bearerToken) {
      ...
      this.headers['Content-Type'] = 'application/vnd.waconvo+json';
    }
    return;
  }
