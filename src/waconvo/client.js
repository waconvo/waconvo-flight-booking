 ...
 *
 * ```js
 * waconvo.client.get('/v1/reference-data/urls/checkin-links', params);
 * waconvo.waconvo.reference_data.urls.checkin_links.get(params);
 * ```
 *
 * @param {Object} options a list of options. See {@link WAConvo} .
...
class Client {
   ...
   *
   * ```js
   * waconvo.client.get('/v2/foo/bar', { some: 'data' });
   * ```
   ...
   *
   * ```js
   * waconvo.client.post('/v2/foo/bar', { some: 'data' });
   * ```
   * @param {string} path the full path of the API endpoint
   ...
   *
   * ```js
   * waconvo.client.delete('/v2/foo/bar', { some: 'data' });
   * ```
   * @param {string} path the full path of the API endpoint
   * @param {Object} [params={}] the query string parameters
   * @return {Promise.<Response,ResponseError>} a Promise
   ...
   *
   * ```js
   * waconvo.client.call('GET', '/v2/foo/bar', { some: 'data' });
   * ```
