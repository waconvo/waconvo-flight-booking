import Validator from '../../../src/waconvo/client/validator';
...
describe('Validator', () => {
  ...
  describe('.initOptional', () => {
    it('should return the expected values', () => {
      ...
      process.env.WACONVO_TEST2 = '2';
      process.env.WACONVO_TEST_SNAKE_CASE = '5';
      ...
      process.env.WACONVO_TEST2 = undefined;
      process.env.WACONVO_TEST_SNAKE_CASE = undefined;
    });
  });
